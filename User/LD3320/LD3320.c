...
{	
		...
		//irq pin
		GPIO_InitStructure.Pin = LD3320IRQ_PIN;
		GPIO_InitStructure.Mode = GPIO_MODE_IT_RISING;		
		HAL_GPIO_Init(LD3320IRQ_GPIO_PORT,&GPIO_InitStructure);
...
#if 0 //no need this func in stm32f4
...
{
	SPIx_Init(); //call stm32 bsp spi init
#if 0
